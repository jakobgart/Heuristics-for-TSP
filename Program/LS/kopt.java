...
public class kopt {
	...
	Extra notes (if you'll look through the algoritm):
	...
	-a=city1 and b=city2 is the same thing as a=city2 and b=city1, unlike in 3-opt (which is coded lower) since we'll order the selected 3-opt cities. 
		This should not affect the "fairness" of picking any two edges in our algorithm.
	*/
	...
	*/
	...
	//generates a random 2opt move and returns it (could be better or worse). This is for Simulated Annealing
	...
	//Generates a random 3opt move, could be better or worse (very similart to first best). This is for Simulated Annealing
